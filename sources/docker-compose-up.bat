...
docker compose -f docker-compose-sqlite.yml build --build-arg DATABASE_PROVIDER=postgres --no-cache && docker compose -f docker-compose-sqlite.yml up --force-recreate -d
